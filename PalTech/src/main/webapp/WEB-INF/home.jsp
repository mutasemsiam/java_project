...
<title>PalTech Home</title>
  ...
  <link rel="stylesheet" href="css/worker2.css">
</head>
<body>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-3 py-lg-0">
             ...
             <a href="/allworkers" class="nav-item nav-link">All Worker</a>
                ...
                <c:if test="${thisuser  == null and thisworker == null}">
...
<c:if test="${thisuser  != null or thisworker != null}">
        ...
        <div class="container">
            <div class="row g-5 align-items-end mb-5">
                ...
                <div class="col-lg-6 text-lg-end wow fadeInUp" data-wow-delay="0.3s">
                    <a class="btn btn-primary py-3 px-5" href="/allworkers">More workers</a>
                </div>
            </div>
   	<c:if test="${thisuser  != null or thisworker != null}">
            ...
            <div class="row g-4 justify-content-center">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item bg-light overflow-hidden h-100">
                        <img class="img-fluid" src="img/izz.PNG" alt="" style="height:300px; width:100%">
               ...
               <c:if test="${thisuser  == null or thisworker == null}"> 
               	<h3>Please login in order to see more details..</h3>
                </c:if>  
                    
                </div>
                
                <c:forEach var="wo" items="${top}">
                 <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item bg-light overflow-hidden h-100">
                        <img class="img-fluid" src="${wo.pic }" alt="" style="height:300px; width:100%">
                        <div class="service-text position-relative text-center h-100 p-4">
                            <h5 class="mb-3">${wo.firstName } ${worker.lastName }</h5>
                            <p>${wo.profession } in ${wo.workerAddress }</p>
                             <a class="small" href="/worker/${wo.id }">More about ${wo.firstName }<i class="fa fa-arrow-right ms-3"></i></a>
                        </div>
